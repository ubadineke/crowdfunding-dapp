    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          ...
          <div className="ml-2 text-2xl font-bold text-purple-300">x</div>
          <div>
            <Link href="https://ackee.xyz" target="_blank">
              <div className="relative block w-[7rem] h-[6rem]">
                <Image src={'/ackee.png'} alt={'Ackee logo'} fill />
              </div>
            </Link>
          </div>
